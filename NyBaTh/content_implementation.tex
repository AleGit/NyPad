...
arbitrary graphs and therefore syntax trees can be represented easily (see \figref{fig:NyayaNode}).
...
\Nyaya's \BoolTool does not parse as fast and (memory) efficient as \verb+BoolTool+'s parser,
