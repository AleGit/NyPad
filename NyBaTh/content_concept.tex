...
\hyperref[tut:1DC]{1DC}, 
\hyperref[tut:1SY]{1SY},
\hyperref[tut:1LI]{1LI}
) 
...
(2PRE) Precedence of connectivea is introduced. 
...
and if it can be simplified to bottom ($\perp$).
...
\subsubseciont{Boolean functions}
\label{tut:501}
...
The smallest possible formula consists of one atom with one symbol from the set $\{ \top, \perp p, q, r, … \}$.
...
$ $&$\TAP{\top}$&$ 	$						&	&$\TAP{P}$&$ $				\\
\\
$P$&$\TAP{\vee}$&$\perp$					&$P$&$ \TAP{\wedge}$&$\perp$		\\
\hline
$ $&$\TAP{P}$&$ $							&$ $&$ \TAP{\perp}$&$ $				\\
\\
