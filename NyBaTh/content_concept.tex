...
In the interactive part the user has to guess the forma structure of composite sentences in natural language. 
...
The user has to draw the syntax tree for simple formulas. They has to pay attention to the precedence of connectives.
...
\label{tut:303}
(303) Semantic entailment and equivalenced is defined and explained with various examples.
...
\label{tut:304}
(304) Satisfiability of propositional formulas is defined and demonstrated. 

The user has to guess or calculate if a presented formula is satisfiable, valid or a contradiction.
