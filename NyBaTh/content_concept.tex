...
The standard symbols “$ \neg \vee \wedge \rightarrow $” and additional symbols of propositional logic and Boolean expressions
 should be accepted too (see \tabref{tab:BASICSYMBOLS}) for extended or custom keyboards.
A limitation of the identifiers for atoms on Latin letters is not necessary (\figref{fig:BoolToolChineseInput})
