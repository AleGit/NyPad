...
The interactive environment contains the functionality of
\href{http://cl-informatik.uibk.ac.at/software/booltool/}{BoolTool} 
developed and published by the Computational Logic Research Group
of the Institute of Computer Science at the University of Innsbruck.
This reimplementation is referenced as \verb=Bool+Tool=.

\subsection{Input}

\verb=Bool+Tool= supports Latin letters as identifiers for atoms. 
...
and the parenthesis \verb#(# and \verb#)#,
because these ASCII-symbols can be found on almost every keyboard,
which could be attached to an iPad running \Nyaya.

\verb=Bool+Tool= also accepts standard symbols “$ \neg \vee \wedge \rightarrow $” 
and additional symbols of propositional logic and Boolean expressions
(see \tabref{tab:BASICSYMBOLS}),
