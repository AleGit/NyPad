...
The first sentence/solutions array of strings starts in line 7 and ends in line 10. 
The first string in the first array (at line 7) is a sentence 
which must be analyzed in all three exercises. 
The next string (at line 8) is a correct solution of the first exercise,
the third string (at line 9) is a correct solution of the second exercise,
and the last string in the array (at line 10) is a correct solution of the third exercise.  
...
is to be used as a sample solution in the exercise.
...
of formulas with their negations. Additional basic equivalences are introduced.
...
The distributions of disjunctions over conjunctions are presented
and proved with a truth table.
...
For convenience’s sake  in the exercises
...
but is feasible because the implication free form was introduced 
...
independent of the valuation status of any sub-node.
...
and additional content is defined in the glossary.
...
just using a keyboard attached to an iPad running \Nyaya.
...
the truth table and an ordered and
