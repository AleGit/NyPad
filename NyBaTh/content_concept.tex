...
\subsubsection{Applications of Propositional logic}
\label{tut:11}
...
\label{tut:33}
(33) Semantic entailment and equivalenced is defined and explained with various examples.
...
In environments with native unicode support it is is desirable that standard symbols of propositional logic
