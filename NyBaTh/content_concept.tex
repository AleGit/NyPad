...
The content is written into  a simple property list “QA1.plist” \tabref{tab:QA1} 
...
The tutorials has their own configuration files “101.plist” \tabref{tab:101PLIST},
...
\end{lstlisting}
\caption{Structure of a simple property list \tabref{tab:PLISTDTD}}
\end{center}
\label{tab:PLISTHEAD}
\end{table}%
