...
The interactive environment have to contain the functionality of the
\href{http://cl-informatik.uibk.ac.at/software/booltool/}{BoolTool web frontend}.

\subsection{Input}

At least the embedded BoolTool must support Latin letters as identifiers for atoms, 
and have to parse the symbols
\verb#T# as top, 
\verb#F# as bottom,
...
because Chinese symbols make good identifiers too (\figref{fig:BoolToolChineseInput}).
